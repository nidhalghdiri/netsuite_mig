export async function createTransaction(
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/api/netsuite/transaction/${recordType}/create-record`,
      {
        method: "POST",
        headers: {
...
export async function fetchNewTransaction(
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}/api/netsuite/transaction/${recordType}/fetch-new-record`,
      {
        method: "POST",
