...
export function isSessionValid(session) {
  ...
  // Session is valid for 1 hour (adjust as needed)
  const SESSION_VALIDITY_DURATION = 60 * 60 * 1000; // 1 hour
  return Date.now() - session.timestamp < SESSION_VALIDITY_DURATION;
}
