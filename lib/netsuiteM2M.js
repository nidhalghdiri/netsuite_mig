...
async function fetchAccessToken() {
  ...
  const jwtHeader = {
    alg: "PS256",
    typ: "JWT",
    kid: "dO2zLhHRMwZDWqAuvTTho2qxIVE3LyT7ZBvtsbxNe3w",
  };
  ...
  const jwtPayload = {
    iss: "3be458c966420e34e3172932bddef79abd1425991bc5f988ae961e73dcb0feb4",
    scope: ["restlets", "rest_webservices"],
    iat: now,
    exp: now + 3600, // 1 hour expiration
    aud: "https://11661334-sb1.suitetalk.api.netsuite.com/services/rest/auth/oauth2/v1/token",
  };
