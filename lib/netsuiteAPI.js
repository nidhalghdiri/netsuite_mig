...
export async function fetchRecordData(recordType, instanceType, token) {
  try {
...
function getRecordEndpoint(recordType) {
  const endpoints = {
    overview: "/dashboard",
    "sales-orders": "/record/v1/salesorder",
    purchases: "/record/v1/purchaseorder",
    invoices: "/record/v1/invoice",
    customers: "/record/v1/customer",
  };

  return endpoints[recordType] || "/record/v1/unknown";
}
