export const initiateOAuth = (instanceType) => {
  ...
  window.location.href = `${authUrl}?client_id=${clientId}&redirect_uri=${redirectUri}&response_type=code&scope=rest_webservices&account=${accountId}&state=ykv2XLx1BpT5Q0F3MRPHb94j`;
};
