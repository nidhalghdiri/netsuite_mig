...
export async function POST(request) {
  ...
  console.log("[creditMemo] AccountId: ", accountId);
  console.log("[creditMemo] token: ", token);
  console.log("[creditMemo] internalId: ", internalId);
  ...
  try {
    ...
    console.log("[creditMemo] New Record : ", record);
